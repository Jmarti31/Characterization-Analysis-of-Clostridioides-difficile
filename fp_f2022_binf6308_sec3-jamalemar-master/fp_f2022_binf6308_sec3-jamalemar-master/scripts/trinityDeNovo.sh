...
leftReads="$(ls -q data/RNAtrimmed/paired/SRR2128480*_1.fastq)"
...
rightReads="$(ls -q data/RNAtrimmed/paired/SRR2128480*_2.fastq)"
...
# Uses trimmed reads to create a de-novo transcriptome assembly, no reference
Trinity \
--seqType fq \
